...
MaterialApp(
      ...
      home: Scaffold(
        ...
        bottomNavigationBar: FloatingBottomBar(
          controller: _controller,
          items: [
            FloatingBottomBarItem(Icons.library_books, label: 'Sayfa 1'),
            FloatingBottomBarItem(Icons.add_box, label: 'Sayfa 2'),
            FloatingBottomBarItem(Icons.business, label: 'Sayfa 3'),
          ],
